...
const btn=document.querySelector(".btn"),tl=new TimelineLite({paused:!0,reversed:!0});function toggleTween(e){e.reversed()?e.play():(e.reverse(),document.getElementById("text").innerHTML="Hi,Welcome",btn.innerHTML="View More")}tl.to(".whitebg",.7,{borderRadius:"0%",width:"100vw",ease:Power1.easeInOut,onComplete:function(){document.getElementById("text").innerHTML="Yeeh...!",btn.innerHTML="Go Back"}}),btn.addEventListener("click",e=>{if(tl.isActive())return e.preventDefault(),e.stopImmediatePropagation(),!1;toggleTween(tl)});